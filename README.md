...
- **Authentication**: OIDC (OpenID Connect) integration for secure user authentication
...
### Authentication
- OIDC-based authentication via configurable identity provider
...
│   └── intergratiobs/        # Auth integration
...
### Authentication
- **OIDC Provider**: Configurable OpenID Connect identity provider
...
- **Tailwind CSS**: Utility-first styling# TASTE-TREK
